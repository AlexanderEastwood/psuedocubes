...
The completion ledger and historical receipts are frozen; the structural audit and witness verification passed. The [completion evidence](results/completion-2026-09-16/) records source/snapshot hashes and the exact match to two independent CPU cube-count controls. An [OEIS witness/upper-bound draft](oeis/draft.html) is prepared but has not been submitted; its sequence destination still needs confirmation. The [versioned evidence summary](https://github.com/AlexanderEastwood/psuedocubes/tree/8a163cd44cdc21ea5da65a5d1b0d0418cdf8417e/results/completion-2026-09-16) is publicly accessible. No b-file is fabricated from a bound or an unproved minimum. Full receipt archives remain separate from Git and can be published as versioned release assets after their provenance and public contents are reviewed.
